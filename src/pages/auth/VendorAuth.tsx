...
import { ArrowLeft, Store, Upload, Clock } from "lucide-react";
    ...
    try {
      ...
      if (data.user) {
        ...
        toast({
          ...
          description: "Please upload your vendor license to continue.",
        });
      ...
      <div className="min-h-screen bg-gradient-subtle flex items-center justify-center p-4">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="text-center space-y-2">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-secondary shadow-secondary">
        ...
        <Card className="max-w-md p-8 text-center space-y-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Your vendor license is currently being reviewed by our administrators.
      ...
      <div className="min-h-screen bg-gradient-subtle flex items-center justify-center p-4">
        <Card className="max-w-md p-8 space-y-6">
          <div className="text-center space-y-2">
            ...
            <h2 className="text-2xl font-bold">Upload Vendor License</h2>
            <p className="text-muted-foreground">
              Please upload your business or food-handling license for verification.
            </p>
          </div>
